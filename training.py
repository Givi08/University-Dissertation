...
class TrainManager:
    ...
    def train_and_validate(self, train_data: Dataset, valid_data: Dataset) \
        ...
        for epoch_no in range(self.epochs):
            ...
            for batch in iter(train_iter):
                ...
                batch_loss, noise = self._train_batch(batch, update=update) #.to('cuda')
    ...
    def _train_batch(self, batch: Batch, update: bool = True) -> Tensor:
        ...
        batch_loss, noise = self.model.get_loss_for_batch(
            batch=batch, loss_function=self.loss) #.to('cuda')
...
def train(cfg_file: str, ckpt=None) -> None:
    ...
    # Train the model
    trainer.train_and_validate(train_data=train_data, valid_data=dev_data) #.to('cuda')
