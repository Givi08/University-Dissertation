...
from ProgressiveTransformer.VariousEncoders.PositionalEncoders import AbsolutePositionalEncoder
...
class TransformerEncoder(Encoder):
    ...
    def __init__(self,
        ...
        self.pe = AbsolutePositionalEncoder(hidden_size)
