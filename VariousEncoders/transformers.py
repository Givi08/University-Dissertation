...
import sys
sys.path.append('C:\\Users\\giova\\OneDrive\\Documenti\\GitHub\\diss\\ProgressiveTransformer')
from VariousEncoders.attentions import MultiHeadAttention
print('\n\n\n\n here \n\n\n\n')
from VariousEncoders.PositionalEncoders import AbsolutePositionalEncoder, T5RelativePositionalEncoder
torch.device('cuda')
